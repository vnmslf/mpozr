...
$APPLICATION->SetPageProperty("keywords", "форменные головные уборы, шапки ушанки, фуражки, пилотки");
$APPLICATION->SetPageProperty("title", "Форменные головные уборы мужские");
$APPLICATION->SetTitle("Форменные головные уборы для мужчин");
?>
...
<div class="wrap" style="padding-top:90px;">
                  <div class="catalog">
                    <div class="titled" style="text-align:left;">
                      Форменные головные уборы мужские
                    </div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":{\"1\":{\"CLASS_ID\":\"CondIBProp:2:5\",\"DATA\":{\"logic\":\"Equal\",\"value\":9}}}}",
