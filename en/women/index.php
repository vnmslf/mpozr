...
$APPLICATION->SetPageProperty("title", "Форменные головные уборы женские");
...
<div class="wrap" style="padding-top:90px;">
                  <div class="catalog">
                    <div class="titled" style="text-align:left;">
                      Форменные головные уборы женские
                    </div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":{\"1\":{\"CLASS_ID\":\"CondIBProp:2:5\",\"DATA\":{\"logic\":\"Equal\",\"value\":10}}}}",
