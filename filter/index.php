...
<div class="filter fil1" >
  <span>Для кого</span>
  <div>
  <input id="zvanie1" name="zvanie" type="radio" value="1"><label for="zvanie1">Для высшего офицерского состава</label>
  <input id="zvanie2" name="zvanie" type="radio" value="2"><label for="zvanie2">Для старшего офицерского состава</label>
  <input id="zvanie3" name="zvanie" type="radio" value="3"><label for="zvanie3">Для среднего офицерского состава</label>
  <input id="zvanie4" name="zvanie" type="radio" value="4"><label for="zvanie4">Для младшего офицерского состава</label>
  <input id="zvanie4" name="zvanie" type="radio" value="4"><label for="zvanie4">Для рядового состава</label>
  <input id="zvanie4" name="zvanie" type="radio" value="4"><label for="zvanie4">Для воспитанников кадетских корпусов</label>
  <input id="zvanie4" name="zvanie" type="radio" value="4"><label for="zvanie4">Для федеральных государственных гражданских служащих</label>
  </div>
</div>
...
<div class="filter fil3" >
  ...
  <input id="vedomstvo5" name="vedomstvo" type="radio" value="ВКС РФ"><label for="vedomstvo5">ВКС РФ</label>
  ...
  <input id="vedomstvo13" name="vedomstvo" type="radio" value="ФГГС РФ"><label for="vedomstvo13">ФГГС РФ</label>
  <input id="vedomstvo14" name="vedomstvo" type="radio" value="СЛО РФ"><label for="vedomstvo14">СЛО РФ</label>
  <input id="vedomstvo15" name="vedomstvo" type="radio" value="РПК РФ"><label for="vedomstvo15">РПК РФ</label>
  <input id="vedomstvo16" name="vedomstvo" type="radio" value="ПОГРАНИЧНАЯ СЛУЖБА ФСБ РФ"><label for="vedomstvo16">ПОГРАНИЧНАЯ СЛУЖБА ФСБ РФ</label>
  </div>
