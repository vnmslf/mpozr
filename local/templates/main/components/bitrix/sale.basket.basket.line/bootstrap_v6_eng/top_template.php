...
<?if (!$compositeStub && $arParams['SHOW_AUTHOR'] == 'Y'):?>
	<div class="mb-1 basket-line-block">
		...
		<span><img src="/local/templates/main/img/svg/lc.svg" alt=""><a style="margin-right:20px;" class="" href="/en<?=$arParams['PATH_TO_PROFILE']?>"><?=htmlspecialcharsbx($name)?></a>
			<a style='margin-right: 0;' href="?logout=yes"><?=GetMessage('TSB1_LOGOUT')?></a></span>
			<span><a href="/en<?=$arParams['PATH_TO_BASKET']?>"><img src="<?=SITE_TEMPLATE_PATH?>/img/svg/korzina.svg" alt=""><?=GetMessage('TSB1_CART')?></a></span>	
		...
		<?else:
			...
			<span><img src="<?=SITE_TEMPLATE_PATH?>/img/svg/lc.svg" alt="">LOGIN</span>
			<span><a href="<?=$arParams['PATH_TO_BASKET']?>"><img src="<?=SITE_TEMPLATE_PATH?>/img/svg/korzina.svg" alt=""><?=GetMessage('TSB1_CART')?></a></span>	
