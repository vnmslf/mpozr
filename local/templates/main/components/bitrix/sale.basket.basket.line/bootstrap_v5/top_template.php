...
<?if (!$compositeStub && $arParams['SHOW_AUTHOR'] == 'Y'):?>
	<div class="mb-1 basket-line-block">
		...
		<span><img src="/local/templates/main/img/svg/lc.svg" alt=""><a style="margin-right:20px;" class="" href="<?=$arParams['PATH_TO_PROFILE']?>"><?=htmlspecialcharsbx($name)?></a>
		...
		<?else:
			...
			<span><img src="<?=SITE_TEMPLATE_PATH?>/img/svg/lc.svg" alt="">Вход</span>
			<span><a href="<?=$arParams['PATH_TO_BASKET']?>"><img src="<?=SITE_TEMPLATE_PATH?>/img/svg/korzina.svg" alt=""><?=GetMessage('TSB1_CART')?></a></span>	
