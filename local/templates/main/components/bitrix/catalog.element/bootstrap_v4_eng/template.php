				...
				<div class="prod_r">
						...
						<div class="rodds">
							...
							<?php
								...
								<?php if( $arResult["PROPERTIES"]["strike"]['VALUE'] != ''): ?>
									...
									<div class="old_price">
										<?php echo $arResult["PROPERTIES"]["strike"]['VALUE'] ?> RUB.
									</div>
					...
					<? if ($arResult["PROPERTIES"]['personal']['VALUE']){?>
						...
						<div class="rod">
							...
							<div class="rodds">
								<?=$arResult["PROPERTIES"]["personal"]['VALUE']?> RUB.
							</div>
						</div>
					<?}?> 
					...
					<div class="chared">
						...
						<div class="rodds">
							Delivery is carried out by the Courier Service of the Russian Post, according to the tariffs set for your region. The cost of delivery of the goods to the place of destination is calculated while ordering. IN THE EVENT OF LACK OF PAYMENT FOR DELIVERY THE GOODS ARE CONSIDERED TO BE ISSUED FOR PICKUP.
						</div>
					</div>
					...
					<div class="chared">
						...
						<div class="rodds">
							Free at the address: the city of Moscow, Dmitrov highway, house 79, building 1, floor 2.2<br/>
						</div>
					</div>
					...
					<div class="chared">
						...
						<div class="rodds">
						The sizes indicated in the goods card are available
						</div>
					</div>
					...
					<div class="chared">
						<div class="rod">
							<span>INDIVIDUAL<br/> SEWING</span>
						</div>

						<div class="rodds">
						You can order an individual sewing of uniforms for military personnel from a private soldier to a colonel that are available in the assortment of ZOLOTOE RUNO presented on this website. <br/>

						When placing an order, fill in the measurement sheet and send it to us. The term for making goods, cost and delivery terms are discussed individually with the Factory manager.
						</div>
					</div>
					...
					<div class="chared">
						...
						<div class="rodds">
						Secure payment by cash or bank card. <br/>
						Attention! In accordance with the Federal Law "On the use of cash registers in the implementation of cash settlements in the Russian Federation" paper checks are not issued From July 1, 2019. You will receive a check by email. Please make sure your email is correct in your contact details.
						</div>
					</div>
					...
					<div class="chared">
						<div class="rod">
							<span>DELIVERY IN RUSSIA AND WORLDWIDE</span>
						</div>

						<div class="rodds">
							Delivery is carried out by the courier service of the Golden Fleece factory in Moscow and the Moscow region; in the regions of Russia and other countries delivery is carried out by the Courier Service of the Russian Post, according to the tariffs set for your region. The cost of delivery of the goods to the place of destination is calculated while ordering. IN THE EVENT OF LACK OF PAYMENT FOR DELIVERY THE GOODS ARE CONSIDERED TO BE ISSUED FOR PICKUP.
						</div>
					</div>
	...
	<div class="wrap_list">
		...
		<div class="tabbed">
			<div class="tab_l">
				...
				<h2>SIZE</h2>
				<p>Available sizes of the goods are shown in the goods card. Please send a request to E-MAIL if the required size is not available</p>

			</div>
			<div class="tab_r">

				<h2>PLACE AN ORDER WITH US</h2>
				<p>Call us at the phone number +7 (495) 744-79-12 (call within Russia is free). Working hours from Monday to Friday: from 09:00 AM to 6:00 PM. Non-working days: Saturday, Sunday.</p>

				<h2><a href="/en/individual/">AN INDIVIDUAIL SEWING</a></h2>

				<h2><a href="/en/dostavka/">TERM AND COST OF DELIVERY</a></h2>

				<h2><a href="/en/vozvrat/">RETURN AND REFUND</a></h2>
...
<h2 class="recs">RECOMMENDATION</h2>
<h3 class="withp">BUY WITH THIS PRODUCT</h3>
