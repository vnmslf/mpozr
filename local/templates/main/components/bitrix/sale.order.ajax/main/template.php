...
<div class="inwra">
			...
			<div class="col-lg-8 col-md-7 bx-soa">
				...
				<div id="bx-soa-orderSave">
					...
					<div id="bx-soa-total" class="col-lg-4 col-md-5 bx-soa-sidebar">
						...
						<a href="javascript:void(0)" style="margin:10px 0px;" class="btn btn-primary btn-lg btn-order-save" data-save-button="true">
						<?=$arParams['MESS_ORDER']?>
					</a>
					</div>
	...
	<div class="cartr">
		<div class="preimed">
			<img src="/local/templates/main/img/p1.png" alt="">
			<span>Безопасность</span>
			<p>Безопасность платежей гарантируется использованием SSL протокола. Данные вашей банковской карты надежно защищены при оплате онлайн.</p>
		</div>
		<div class="preimed">
			<img src="/local/templates/main/img/p2.png" alt="">
			<span>ДОСТАВКА ПО ВСЕЙ РОССИИ</span>
			<p>По Москве и Московской области доставка курьерской службой фабрики Золотое Руно, по России доставка ведущими курьерскими компаниями.</p>
		</div>
		<div class="preimed">
			<img src="/local/templates/main/img/p3.png" alt="">
			<span>ПРИМЕРКА</span>
			<p>Примеряйте и оплачивайте только подходящие товары. Вы можете примерить вещи перед
			покупкой и взять лишь те, которые вам подошли.</p>
		</div>
		<div class="preimed">
			<img src="/local/templates/main/img/p4.png" alt="">
			<span>ИНДИВИДУАЛЬНЫЙ ПОШИВ</span>
			<p>Вы можете заказать индивидуальный пошив
			форменной одежды носителей воинских званий
			от рядового до полковника, имеющейся
			в ассортименте фабрики «Золотое Руно»
			и представленной на данном сайте.
			При оформлении заказа заполните обмерочный лист и пришлите нам. Сроки изготовления, стоимость и условия доставки обсуждаются индивидуально с менеджером Фабрики.</p>
		</div>
	</div>
